import { 
  ...
  import moduleStyles from "./LayoutIdrgaming.scss?inline";

import { makeContactLinks, extendProtocol } from "~/utils/sysUtils"; 
import { useCommonViewData } from "~/hooks/app/useCommonViewData";
  import Header from "~/modules/headers/variant-4/Header4";
...
import Footer from "~/modules/footer/variant-5/Footer5";
