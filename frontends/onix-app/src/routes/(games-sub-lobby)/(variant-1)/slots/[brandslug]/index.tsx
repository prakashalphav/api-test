...
import styles from "./slots.scss?inline";
...
export default component$(() => {
  ...
  return (
    <>
      <Title hasMobileBackUrl={true} mobileBackUrl={`/slots/`}> {t("app.Slots Games@@Slots Games")} </Title>

      <Resource
        value={subGames}
        onPending={() => <div>Loading...</div>}
        onRejected={(e) => <div>Error : {JSON.stringify(e.message)}</div>}
        onResolved={(d) => {
