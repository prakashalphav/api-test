...
import styles from './casino.scss?inline';
            ...
            <Resource value={cvResource} 
              ...
              onResolved={(d ) => ( <>     
                { commonData.app_sub_skin === "zplay" ? (
                  <Lobby2 providers={Object.values(d.d?.games_data.casino as any)}></Lobby2>
                ) : (
                  <Lobby1 providers={Object.values(d.d?.games_data.casino as any)}></Lobby1>
                )} 
        </>)}/>
    </>;
})